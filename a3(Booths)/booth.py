...
def main():
    ...
    #ml = input("Input the bit length of first variable M: ")
    #mlen = int(ml)
    #rl = input("Input the bit length of second variable R: ")
    #rlen = int(rl)

    #fv = input("Input the number of first variable M: ")
    m = int(firebase.get('/booth','m'))
    ...
    r = text2 = int(firebase.get('/booth','r'))
